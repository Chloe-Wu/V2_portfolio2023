...
const Contact = () => {
  return (
    <div className='gpt3_whatgpt3 section_margin' id="contact">
      <div className='gpt3_whatgpt3_feature'>
        <Feature title="Get In Touch" text={<p><p>I’m currently looking for new opportunities, and my inbox is always open. If you have a question or want to grab a coffee, send me an email!</p><p className='email'><a href = "mailto: yiweiwu.hello@gmail.com">yiweiwu.hello@gmail.com</a></p></p>}/>
      </div>
